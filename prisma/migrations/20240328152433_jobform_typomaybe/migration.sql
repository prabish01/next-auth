...
-- CreateEnum
CREATE TYPE "JobCategory" AS ENUM ('Agriculture', 'Construction', 'HospitalityAndTourism', 'RetailAndConsumerGoods', 'FacilityManagementAndSupportServices', 'TransportationAndLogistics');
...
CREATE TABLE "Job" (
    ...
    "jobSalary" DOUBLE PRECISION NOT NULL,
